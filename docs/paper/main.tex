...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Benchmark: Logit fraccionado como modelo de referencia
    \end{itemize}
...
\textbf{Modelo Benchmark}: Logit fraccionado
\begin{itemize}
    \item Maneja variables acotadas entre 0 y 1
    \item Especificación: $E[Y_{k,t}|X] = \frac{\exp(\eta)}{1 + \exp(\eta)}$
